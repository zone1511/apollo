...
public abstract class BaseEntity {
	public static class BaseEntityListener{
		@PrePersist
		public void preInsert(BaseEntity obj) {
			if (obj.dataChangeCreatedBy == null)
				obj.dataChangeCreatedBy = "default";
			if (obj.dataChangeCreatedTime == null) {
				obj.dataChangeCreatedTime = new Date(System.currentTimeMillis());
			}
		}
